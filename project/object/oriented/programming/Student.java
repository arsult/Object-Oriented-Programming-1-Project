package project.object.oriented.programming;
...
public class Student {
    ...
    public void viewStudentSchedule() {
        ...
        for (int i = 0; i < Days.values().length; i++) {
            ...
            System.out.printf("%s:%20s: %20s: %20s:\n", "Time", "me.ted.courses.Course", "Code", "Classroom");
    ...
    public String toString() {
        return "me.ted.person.Student's Name: " + name + "\nme.ted.person.Student's ID: " + universityID + "\nme.ted.person.Student's Year: " + level + "\nCurrent Credit Hours: " + calculateCumulativeCreditHours();
    }
